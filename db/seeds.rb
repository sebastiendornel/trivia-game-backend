...
resp2 = RestClient.get 'https://opentdb.com/api.php?amount=51'
resp3 = RestClient.get 'https://opentdb.com/api.php?amount=52'
resp4 = RestClient.get 'https://opentdb.com/api.php?amount=53'
resp5 = RestClient.get 'https://opentdb.com/api.php?amount=54'
resp6 = RestClient.get 'https://opentdb.com/api.php?amount=55'
resp7 = RestClient.get 'https://opentdb.com/api.php?amount=56'
resp8 = RestClient.get 'https://opentdb.com/api.php?amount=57'
resp9 = RestClient.get 'https://opentdb.com/api.php?amount=58'
resp10 = RestClient.get 'https://opentdb.com/api.php?amount=59'
resp11 = RestClient.get 'https://opentdb.com/api.php?amount=60'
resp12 = RestClient.get 'https://opentdb.com/api.php?amount=61'
resp13 = RestClient.get 'https://opentdb.com/api.php?amount=62'
resp14 = RestClient.get 'https://opentdb.com/api.php?amount=63'
resp15 = RestClient.get 'https://opentdb.com/api.php?amount=64'
resp16 = RestClient.get 'https://opentdb.com/api.php?amount=65'
resp17 = RestClient.get 'https://opentdb.com/api.php?amount=66'
resp18 = RestClient.get 'https://opentdb.com/api.php?amount=67'
resp19 = RestClient.get 'https://opentdb.com/api.php?amount=68'
resp20 = RestClient.get 'https://opentdb.com/api.php?amount=69'
...
# byebug
json1["results"].each{|question| Question.create(question_text: cleaner(question["question"]), correct_answer: cleaner(question["correct_answer"]), incorrect_answers: cleaner(question["incorrect_answers"]))}
json1["results"].each{|question| Question.create(question_text: cleaner(question["question"]), correct_answer: cleaner(question["correct_answer"]), incorrect_answers: question["incorrect_answers"])}